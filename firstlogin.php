...
<?php
    ...
    if (strlen($password) >= 6 && $password == $checkpassword ){
        ...
        mysqli_query(mysqli_connect("localhost","root","123","Login"), $sql_set_password);
...
<form action="firstlogin.php" method="post" >
  <div align="center" style="background-color:#00000000;padding:10px;margin-bottom:5px;">
    <br>
    <h1 ><font color='green'>第一次登入更改密碼 </font></h1>
    ...
    <input type="button" value="回到登入頁面" onclick="location.href='/web/login.php'">
  </div>
</form>
</body>
</html>